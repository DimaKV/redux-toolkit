...
// создаем экшены, которые будут получать/отправлять данные из API
// вызываем их с помощью dispatch() в компоненте
// при срабатывании экшена - будет происходить работа в asyncTodoSlice (extraReducers)
...
>(
    ...
    {
        // если мы уже что-то грузим, то не вызывай загрузку данных
